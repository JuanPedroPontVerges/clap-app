    ...
    <div class="container">
      <el-row type="flex" justify="space-between" align="middle" class="page-title">
        <el-col :sm="20" >
          <h1>Personas</h1>
          <p>
            Aquí se listan los colaboradores, empleados y proveedores de tu institución.
          </p>
        </el-col>
        ...
        >
              ...
              <el-col :sm="12">
                <el-form-item label="Tipo">
                  ...
                  >
                    ...
                    <el-option label="Proveedor" value="Proveedor"></el-option>
                  </el-select>
                </el-form-item>
              </el-col>
            </el-row>
            <el-form-item v-if="form.tipo == 'Colaborador'">
          ...
          <span slot="footer" class="dialog-footer">
            <el-button type="text" class="danger" @click="toggleDialog">Cancelar</el-button>
        ...
        >
          <el-form :model="formEdit" label-position="top">
            ...
            <el-form-item v-if="formEdit.tipo == 'Colaborador'">
